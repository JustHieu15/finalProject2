        ...
        <div class="p-2">
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 mb-2 bg-gray-700">
                    ...
                    <div class="w-full max-w-[16rem]">
                        <div class="relative">
                            ...
                            <input id="npm-install-copy-button" type="text"
                                   ...
                                   value="COURSENO1" disabled readonly>
                        ...
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <input type="text" id="class_name"
                                       ...
                                       placeholder="Ex: Unit 1" required/>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="flex w-full justify-between items-center mt-3 ">
                    <h2 class="text-white text-base font-semibold">Change course's stage</h2>
                    <form class="flex items-center">
                        <div class="w-full max-w-[16rem] relative">
                            <input type="number" id="course_stage"
                                   class="col-span-6 bg-gray-700 border text-white text-sm rounded-lg block w-64 p-2.5"
                                   placeholder="Ex: 4" required/>
                            <button id="confirm-button"
                                    class="text-center text-sm absolute top-1/2 -translate-y-1/2 right-0 bg-orange-500 text-white rounded-lg px-4 py-2">
                                Confirm
                            </button>
                        </div>
                    </form>
                ...
                <div class="flex space-x-4 justify-end w-full mt-3">
                    ...
                    <button data-modal-target="popup-modal-1" data-modal-toggle="popup-modal-1" type="button"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure
                                        you want to save these changes?</h3>
                                    <button data-modal-hide="popup-modal-1" type="button"
                                            class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                        No, cancel
                                    </button>
                                    <button data-modal-hide="popup-modal-1" type="button"
                                            class="text-white bg-green-400 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                        Yes, I'm sure
                                    </button>
                                </div>
                            </div>
