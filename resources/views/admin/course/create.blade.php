    ...
    <div class="p-4 sm:ml-auto mr-auto max-w-4xl">
        ...
        <div class="p-2">
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 mb-2 bg-gray-700">
                <h1 class="text-white text-xl font-bold">Create new course</h1>

                <form action="{{ route('admin.course.store') }}" class="flex flex-col w-full h-auto items-center" method="POST">
                    @csrf

                    <div class="flex w-full justify-between items-center mt-5">
                        <!-- Class ID -->
                        <h2 class="text-white text-base font-semibold">Course's ID (Auto generated)</h2>
                    ...
                    <div class="flex justify-between w-full items-center mt-3">
                        <h2 class="text-white text-base font-semibold">Insert course's name</h2>
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
