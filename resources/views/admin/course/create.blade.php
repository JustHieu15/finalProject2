    ...
    <div class="p-4 sm:ml-auto mr-auto max-w-4xl">
        ...
        <div class="p-2">
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 mb-2 bg-gray-700">
                <h1 class="text-white text-xl font-bold">Create your new course</h1>
                ...
                <div class="flex justify-between w-full items-center mt-3">
                    <h2 class="text-white text-base font-semibold">Insert your course's name</h2>
                    <form>
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                ...
                <div class="flex w-full justify-between items-center mt-3 ">
                    <h2 class="text-white text-base font-semibold">Insert course's stage</h2>
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure
                                        you want to cancel creating new course?</h3>
